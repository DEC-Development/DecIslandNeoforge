...
import com.dec.decisland.lang.item.en_us.Material
...
import com.dec.decisland.lang.item.zh_cn.Material as ZhCnMaterial
import com.dec.decisland.lang.item.zh_cn.Mask as ZhCnMask
import com.dec.decisland.lang.item.zh_cn.Weapon as ZhCnWeapon

object ItemLang {
    private val enUs = Accessory.translations + Armor.translations + Material.translations + Mask.translations + Weapon.translations
    private val zhCn = ZhCnAccessory.translations + ZhCnArmor.translations + ZhCnMaterial.translations + ZhCnMask.translations + ZhCnWeapon.translations
