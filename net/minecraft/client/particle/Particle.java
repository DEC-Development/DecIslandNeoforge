...
public abstract class Particle {
    ...
    public Particle(ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
        this(level, x, y, z);
        this.xd = xSpeed + (this.random.nextFloat() * 2.0F - 1.0F) * 0.4F;
        this.yd = ySpeed + (this.random.nextFloat() * 2.0F - 1.0F) * 0.4F;
        this.zd = zSpeed + (this.random.nextFloat() * 2.0F - 1.0F) * 0.4F;
