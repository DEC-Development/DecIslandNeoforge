...
public class DamageSources {
    ...
    public DamageSource source(ResourceKey<DamageType> damageTypeKey) {
        return new DamageSource(this.damageTypes.getOrThrow(damageTypeKey));
    }

    public DamageSource source(ResourceKey<DamageType> damageTypeKey, @Nullable Entity entity) {
    ...
    public DamageSource fireball(Fireball fireball, @Nullable Entity shooter) {
        return shooter == null ? this.source(DamageTypes.UNATTRIBUTED_FIREBALL, fireball) : this.source(DamageTypes.FIREBALL, fireball, shooter);
    }
